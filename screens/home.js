    ...
    <ScrollView style={[globalStyles.container]}>
      <View style={styles.thisContainer}>
          ...
          >
            <View style={globalStyles.imageTextContainer}>
              ...
              <Text style={globalStyles.imageText}>
                No dresscode. No labels. No judgement. Come as you are.
              </Text>
            </View>
          </ImageBackground>
        </View>
        <View style={globalStyles.imageContainer}>
          ...
          >
            <View style={globalStyles.imageTextContainer}>
              ...
              <Text style={globalStyles.imageText}>
                We have a complimentary nursery staffed by volunteers or you are
                welcome to bring the kids into the service.
              </Text>
            </View>
          </ImageBackground>
        </View>
        <View style={globalStyles.imageContainer}>
          ...
          >
            <View style={globalStyles.imageTextContainer}>
              ...
              <Text style={globalStyles.imageText}>
                Music. Honest conversations about Jesus and society today.
              </Text>
            </View>
          </ImageBackground>
        </View>
        ...
        <View style={styles.buttonContainer}>
          <FlatButton text='Donate' onPress={handlePress}></FlatButton>
        </View>
        <View style={styles.connectCard}>
          ...
          <View style={globalStyles.block}>
            <Text style={globalStyles.blockText}>
              Fill out our connect card. Let us know if it is your first time
              visiting. Tell us how we can pray for you. Connect with us to
              discuss you next steps with Connection Church. We would love to
              hear from you!
            </Text>
          </View>
